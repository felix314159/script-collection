...
* `ghact.sh`: Get overview of anyone's recent github activity in any repo. E.g. `./ghact.sh ethereum/execution-specs,ethereum/hive felix314159 5` shows all commits made by `felix314159` in the repos `ethereum/execution-specs` or `ethereum/hive` within the past `5` hours
